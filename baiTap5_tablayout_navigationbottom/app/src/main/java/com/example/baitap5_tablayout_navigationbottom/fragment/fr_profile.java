 ...
 * Use the {@link fr_profile#newInstance} factory method to
...
public class fr_profile extends Fragment {
     ...
     * @return A new instance of fragment fr_profile.
     */
    // TODO: Rename and change types and number of parameters
    public static fr_profile newInstance(String param1, String param2) {
        fr_profile fragment = new fr_profile();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       mview = inflater.inflate(R.layout.fragment_fr_profile, container, false);
       tabLayout= mview.findViewById(R.id.tabLayout);
       viewPager = mview.findViewById(R.id.viewPager_profile);
